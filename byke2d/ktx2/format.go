...
var vkFormatToBytePerPixel = map[VkFormat]uint32{
	...
	VK_FORMAT_D24_UNORM_S8_UINT:   24,
	VK_FORMAT_D32_SFLOAT_S8_UINT:  32,
}

//go:generate stringer -type TextureType
...
func (r Reader) TextureType() (TextureType, bool) {
	h := r.Header
	...
	case h.PixelHeight == 0 && h.PixelDepth == 0 && h.LayerCount > 0 && h.FaceCount == 1:
		return TextureType1dArray, true

	case h.PixelHeight > 0 && h.PixelDepth == 0 && h.LayerCount > 0 && h.FaceCount == 1:
		return TextureType2dArray, true

	case h.PixelHeight > 0 && h.PixelDepth > 0 && h.LayerCount > 0 && h.FaceCount == 1:
		return TextureType3dArray, true

	case h.PixelHeight > 0 && h.PixelDepth == 0 && h.LayerCount > 0 && h.FaceCount == 6:
		return TextureTypeCubemapArray, true
